const productosAirMax = [
  {
    ...
    imgHover:
      "https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/748690d8-a3fb-4020-a11d-4b935a0227d6/AIR+MAX+DN.png",
  },

  {
    ...
    precio: "$160.50",
    imgDefault:
      "https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/80384919-bddd-4d9f-8ca5-41a93c893868/W+AIR+MAX+DN.png",
    imgHover:
      "https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/f24971cb-a2ae-4220-b17e-c6efc08edabc/W+AIR+MAX+DN.png",
  },
  {
    nombre: " Nike Air Max Dn SE",
    precio: "$150.50",
    imgDefault:
      "https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/1ef876c6-5a15-4b00-af1b-43c6738e54cd/W+AIR+MAX+DN+SE.png",
    imgHover:
      "https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/01311c2c-a9c6-45ca-9af2-eadb59f1d330/W+AIR+MAX+DN+SE.png",
  },
  {
    nombre: "Nike Aur Nax Dn Premium",
    precio: "$136.50",
    imgDefault:
      "https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/857a9aa3-70e0-4710-b261-952ddcdc4649/W+AIR+MAX+DN+PRM.png",
    imgHover:
      "https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/fc34140c-b4e8-421b-ad0a-41d2ef26479a/W+AIR+MAX+DN+PRM.png",
  },
];
...
function agregarAlCarritoAirMax(nombreProducto, precioProducto) {
  Swal.fire({
    ...
    html: `
            <img src="${
              productosAirMax.find((p) => p.nombre === nombreProducto)
                .imgDefault
